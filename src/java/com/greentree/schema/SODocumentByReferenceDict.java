...
public class SODocumentByReferenceDict<SODocument> extends MemberKeyDictionary<SODocument> {
    ...
    public SODocument getAtKey(String reference) {
        return (SODocument) EntityAccess.sendMsgGetReference(this, "getAtKey", reference);
    }

    public SODocument getAtKeyGeq(String reference) {
        return (SODocument) EntityAccess.sendMsgGetReference(this, "getAtKeyGeq", reference);
    }

    public SODocument getAtKeyGtr(String reference) {
        return (SODocument) EntityAccess.sendMsgGetReference(this, "getAtKeyGtr", reference);
    }

    public SODocument getAtKeyLeq(String reference) {
        return (SODocument) EntityAccess.sendMsgGetReference(this, "getAtKeyLeq", reference);
    }

    public SODocument getAtKeyLss(String reference) {
        return (SODocument) EntityAccess.sendMsgGetReference(this, "getAtKeyLss", reference);
    }
